...
def start(update: Update, context: CallbackContext) -> None:
    ...
    keyboard = [
        [
            InlineKeyboardButton("Создать вакансию", callback_data=str(ONE)),
        ],
        [
...
def accept(update: Update, context: CallbackContext) -> None:
    ...
    reply_markup = InlineKeyboardMarkup(keyboard)
    query.message.edit_text(text="Ник: @{}".format(
        NEEDED["{}".format(update.callback_query.from_user.id)][NUMBER["{}".format(update.callback_query.from_user.id)]%len(NEEDED["{}".format(update.callback_query.from_user.id)])]["username"]
...
def f_computer_help(update: Update, context: CallbackContext) -> None:
    ...
    if (len(NEEDED["{}".format(update.callback_query.from_user.id)])==0):
        ...
        if (NEEDED["{}".format(update.callback_query.from_user.id)][NUMBER["{}".format(update.callback_query.from_user.id)]%len(NEEDED["{}".format(update.callback_query.from_user.id)])]["payment"]!="Сдельная"):
            query.message.reply_text(text="Название: {} \nОписание: {} \nОплата: {} \nСрок: {}".format(
                NEEDED["{}".format(update.callback_query.from_user.id)][NUMBER["{}".format(update.callback_query.from_user.id)]%len(NEEDED["{}".format(update.callback_query.from_user.id)])]["name_of_vacancy"],
                NEEDED["{}".format(update.callback_query.from_user.id)][NUMBER["{}".format(update.callback_query.from_user.id)]%len(NEEDED["{}".format(update.callback_query.from_user.id)])]["about_vacancy"],
                NEEDED["{}".format(update.callback_query.from_user.id)][NUMBER["{}".format(update.callback_query.from_user.id)]%len(NEEDED["{}".format(update.callback_query.from_user.id)])]["payment"],
                NEEDED["{}".format(update.callback_query.from_user.id)][NUMBER["{}".format(update.callback_query.from_user.id)]%len(NEEDED["{}".format(update.callback_query.from_user.id)])]["deadline"]),
                reply_markup=reply_markup)
        else:
            query.message.reply_text(text="Название: {} \nОписание: {} \nОплата: {} \nСтоимость: {} \nСрок: {}".format(
                NEEDED["{}".format(update.callback_query.from_user.id)][
